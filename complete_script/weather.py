...
if __name__ == "__main__":
    ...
    for dataset_name, config in dataset_configs.items():
        ...
        results_file = f"results_{dataset_name}.txt"
        ...
        for pred_len in config["pred_lens"]:
            ...
            try:
                ...
                print(f"Error loading datasets for pred_len={pred_len}: {e}")
                continue
            ...
            print(f"Initialized DataLoaders: batch_size={config['batch_size']}")
            ...
            for aug_type in config["aug_types"]:
                ...
                print(
                    f'{aug_type} - Avg Val Loss: {results["val_loss"]:.6f}, Avg MAE: {results["mae"]:.6f}, '
                    f'Avg MSE: {results["mse"]:.6f}, Avg RSE: {results["rse"]:.6f}, '
                    f'MSE Std: {results["mse_std"]:.6f}'
                )

                # Save results for this aug_type
                with open(results_file, "a") as f:
                    f.write(
                        f"{dataset_name}, pred_len={pred_len}, {aug_type}: "
                        f'Val Loss={results["val_loss"]:.6f}, MAE={results["mae"]:.6f}, MSE={results["mse"]:.6f}, '
                        f'RSE={results["rse"]:.6f}, MAE Std={results["mae_std"]:.6f}, MSE Std={results["mse_std"]:.6f}, '
                        f'RSE Std={results["rse_std"]:.6f}\n'
                    )
